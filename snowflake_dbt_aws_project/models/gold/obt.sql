{% set configs = [
  ...
  },
  {
    ...
    "columns": "SILVER_hosts.HOST_NAME, SILVER_hosts.HOST_SINCE, SILVER_hosts.IS_SUPERHOST, SILVER_hosts.RESPONSE_RATE_QUALITY, SILVER_hosts.CREATED_AT as HOSTS_CREATED_AT",
    "alias": "SILVER_hosts",
